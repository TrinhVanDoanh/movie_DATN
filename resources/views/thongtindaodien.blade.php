        ...
        <div class="content_left">
            <div class="infor_main d-flex mb-4">
                <div class="infor_img me-4">
                    @if($director->avatar)
                        <img src="{{ asset('uploads/director/' . $director->avatar) }}" alt="Avatar của {{ $director->name }}">
                    @else
                ...
                <div>
                    ...
                    <h3 class="fw-bold my-3">{{ $director->name }}</h3>
                    <div>
                    ...
                    <p class="mt-3">
                        @if($director->short_bio)
                            <span>{{ $director->short_bio }}</span>
                        @else
                    ...
                    <div class="mt-4">
                        ...
                        @if($director->birth_date)
                            <span>{{ \Carbon\Carbon::parse($director->birth_date)->format('d/m/Y') }}</span>
                        @else
                            <span>Đang cập nhật</span>
                        @endif
                    </div>
