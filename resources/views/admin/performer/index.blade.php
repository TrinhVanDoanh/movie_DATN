...
@section('main')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                <a href="{{route('performer.create')}}" class="btn btn-success float-right m-4">Thêm diễn viên</a>
            </div>
            <div class="col-md-12">
                <table class="table">
                    <thead>
                    ...
                    <tbody>
                        ...
                        <td scope="col">
                            @if($value_data->avatar)
                                <img src="{{ asset('uploads/performer/' . $value_data->avatar) }}" width="50" alt="">
                            @else
                        ...
                        <td scope="col">
                            <form action="{{ route('performer.destroy', $value_data->id) }}" method="post"
                                name='delete' class="d-flex flex-row">
                                @csrf @method('DELETE')
                                <div class="mr-2">
                                    <a href="{{ route('performer.edit', $value_data->id) }}"
