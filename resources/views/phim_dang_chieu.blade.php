                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <ul class="d-flex align-items-center p-0 m-0">
                                ...
                                <li class="ms-5 fw-bold fs-6 "><a class="text-secondary text-decoration-none"
                                        href="{{ route('movieComingSoon') }}">Sắp chiếu</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="list_move-item w-100 rounded-2">
                                    <div class="w-100">
                                        <a class="text-decoration-none w-full h-100"
                                            href="{{ route('get-movieBookTicket', $movieShowing->id) }}">
                                            <div class="position-relative inline-block">
                                                <div>
                                                    <img class="rounded-2"
                                                        src="{{ asset('uploads/movies/' . $movieShowing->image) }}"
                                                        alt="">
                                                </div>
                                                <div
                                                    ...
                                                    <div class="d-flex flex-column">
                                                        ...
                                                        <button class="btn btn-watch-trailer rounded mt-2"
                                                            ...
                                                            data-trailer="{{ $movieShowing->trailer }}">
                                                            <span><i
